...
const TRANSLATIONS = {
    en: {
        ...
        start: "Start Game! 🚀",
        footer: "Made with ❤️ from 🇨🇷 by @pako.cr, 2025",
    ...
    es: {
        ...
        start: "¡Iniciar Juego! 🚀",
        footer: "Hecho con ❤️ en 🇨🇷 por @pako.cr, 2025",
    ...
    pt: {
        ...
        footer: "Feito com ❤️ na 🇨🇷 por @pako.cr, 2025",
    ...
    de: {
        ...
        start: "Spiel starten! 🚀",
        footer: "Mit ❤️ in 🇨🇷 von @pako.cr hergestellt, 2025",
    ...
    fr: {
        ...
        start: "Lancer le jeu! 🚀",
        footer: "Fabriqué avec ❤️ au 🇨🇷 par @pako.cr, 2025",
    ...
    it: {
        ...
        footer: "Realizzato con ❤️ in 🇨🇷 da @pako.cr - 2025",
